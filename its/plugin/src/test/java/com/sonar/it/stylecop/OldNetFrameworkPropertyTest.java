...
public class OldNetFrameworkPropertyTest {
  ...
  public void test() {
    SonarRunner build = Tests.createSonarRunner()
      ...
      .setProperty("sonar.dotnet.4.0.sdk.directory", new File(orchestrator.getConfiguration().getString("sonar.stylecop.msBuildPath")).getParentFile().getAbsolutePath())
      .setProperty("sonar.dotnet.version", "4.0")
      .setProperty("sonar.sourceEncoding", "UTF-8")
      .setProfile("profile");

    BuildResult buildResult = orchestrator.executeBuild(build);
    assertThat(buildResult.getLogs()).contains(
      "Use the new property \"sonar.stylecop.msBuildPath\" instead of the deprecated \"sonar.dotnet.version\" and \"sonar.dotnet.4.0.sdk.directory\".");
  }
